export const translations = {
  en: {
    ...
    contactEmail: "sales@voltex.am",
    contactPhone: "+374 43 443040",
    contactEmailLabel: "Write an email",
    contactCallLabel: "Call now",
    contactWhatsAppLabel: "WhatsApp",
    contactTelegramLabel: "Telegram",
    contactViberLabel: "Viber",
    contactMapPopup: "Voltex LLC · 44/3 Acharyan St, Yerevan 2210 · +374 43 443040",
    contactOpenGoogleMaps: "Open in Google Maps",
    contactOpenYandexMaps: "Open in Yandex Maps",
    
    // Footer
    footerSocialTitle: "Voltex LLC's social pages",
    ...
    footerAddress: "44/3 Acharyan str, Yerevan, Armenia 2210",
  ...
  am: {
    ...
    contactSubtitle: "",
    contactDescription: "Ստացե՛ք հստակ գին և իրական ժամանակացույց։",
    contactEmail: "sales@voltex.am",
    contactPhone: "+374 43 443040",
    contactEmailLabel: "Գրել @նամակ",
    contactCallLabel: "Զանգահարել",
    contactWhatsAppLabel: "WhatsApp",
    contactTelegramLabel: "Telegram",
    contactViberLabel: "Viber",
    contactMapPopup: "Վոլտեքս ՍՊԸ · Երևան, Աճառյան 44/3 · +374 43 443040",
