          ...
          <div className="hidden md:flex md:col-start-1 md:col-end-2 justify-self-start self-end">
            <div className="w-[260px] sm:w-[300px] lg:w-[360px] aspect-square relative overflow-hidden">
              <img
                ...
                loading="eager"
                draggable={false}
                className="absolute bottom-0 left-1/2 translate-x-[calc(-50%+15px)] translate-y-[35px] h-full w-auto object-contain select-none pointer-events-none scale-[1.45]"
              />
            </div>
          </div>
